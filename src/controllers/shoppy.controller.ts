...
import { saveShop } from '../services/addShoppyShop.service';

// get all shops with limit
const getAllShoppyShops = (req: Request, res: Response) => {
...
// find shop by name
async function getShoppyShopByName(req: Request, res: Response) {
...
// add shop
async function addShoppyShop(req: Request, res: Response) {
...
// Export the object
export default ShoppyController;